...
app.secret_key = "mohit-banking-system-demo-key"
...
def update_branding(response):
    ...
    if "text/html" in content_type:
        try:
            ...
            html = html.replace("MOHIT BANKING SYSTEM", BANK_NAME)
            html = html.replace("MOHIT BANKING SYSTEM", BANK_NAME)
            html = html.replace("MOHIT BANKING SYSTEM", BANK_NAME)
            html = html.replace("MOHIT BANKING SYSTEM", BANK_NAME)
...
def create_database():
    ...
    data = {
        "users": [
            {
                "account_no": "ADMIN001",
                "name": "MOHIT BANKING SYSTEM Admin",
                "email": "admin@mohitbankingsystem.com",
                "phone": "",
                "account_type": "Admin",
